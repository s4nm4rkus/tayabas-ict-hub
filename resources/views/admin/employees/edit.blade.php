    ...
    <div class="anim-fade-up mb-4"
        ...
        <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div class="flex-grow-1">
                ...
                <span class="status-badge badge-gray mt-1">
    ...
    <form method="POST" action="{{ route('admin.employees.update', $employee->user_id) }}" enctype="multipart/form-data">
        ...
        <div class="tab-panel active" id="tab-personal">
            ...
            <div class="edit-section mb-3">
                ...
                <div class="row g-3">
                    <div class="col-md-4"><label class="form-label">Government Email</label>
                        <input type="email" name="gov_email" class="form-control"
                            value="{{ old('gov_email', $employee->gov_email) }}">
                    </div>
                    <div class="col-md-4"><label class="form-label">Position / Role</label>
                    ...
                    <div class="col-md-4"><label class="form-label">Account Status</label>
                        <select name="user_stat" class="form-select">
                            <option value="Enabled" {{ $employee->user?->user_stat == 'Enabled' ? 'selected' : '' }}>Enabled
                            </option>
