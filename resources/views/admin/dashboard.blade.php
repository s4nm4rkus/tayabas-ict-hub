...
@section('content')
            ...
            <div class="stat-card h-100">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        ...
                        <div
                            style="font-size:32px;font-weight:700;color:var(--text-primary);
                    ...
                    <div
                        style="width:44px;height:44px;border-radius:12px;
                            background:linear-gradient(135deg,rgba(110,168,254,0.15),rgba(74,144,226,0.1));
                ...
                <div class="d-flex align-items-start justify-content-between">
                    ...
                    <div
                        style="width:44px;height:44px;border-radius:12px;
                            ...
                            display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <i class="bi bi-file-earmark-check" style="font-size:20px;color:#22C55E;"></i>
                    </div>
                </div>
                <div style="margin-top:14px;padding-top:12px;border-top:1px solid var(--border);">
                    <a href="{{ route('hr.certificates.index') }}"
                        style="font-size:12px;font-weight:600;color:#22C55E;text-decoration:none;">
    ...
    <div class="row g-3 anim-fade-up delay-5">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        ...
                        <div style="font-size:12px;color:var(--text-secondary);margin-top:2px;">
                            Latest submissions across all staff
                        </div>
                    </div>
                    <a href="{{ route('admin.leaves.index') }}" class="btn btn-outline-primary btn-sm">
                        View all
                    </a>
                </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4"
                                        style="text-align:center;padding:2rem;color:var(--text-secondary);font-size:13.5px;">
        ...
        <div class="col-lg-4">
                    ...
                    <a href="{{ route('admin.employees.create') }}"
                        ...
                        <div
                            style="width:30px;height:30px;border-radius:8px;
                                ...
                                display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                            <i class="bi bi-person-plus" style="font-size:13px;color:white;"></i>
                        </div>
                        <div>
                            <div style="font-size:13px;font-weight:600;color:var(--text-primary);">Add Employee</div>
                            <div style="font-size:11px;color:var(--text-secondary);">Register new staff</div>
                        </div>
                        <i class="bi bi-chevron-right ms-auto" style="font-size:12px;color:var(--text-secondary);"></i>
                    </a>

                    <a href="{{ route('admin.employees.import.form') }}"
                        style="display:flex;align-items:center;gap:10px;padding:10px 12px;
                          border-radius:10px;text-decoration:none;
                        ...
                        <div>
                            <div style="font-size:13px;font-weight:600;color:var(--text-primary);">Import CSV</div>
                            <div style="font-size:11px;color:var(--text-secondary);">Bulk employee upload</div>
                        </div>
                        <i class="bi bi-chevron-right ms-auto" style="font-size:12px;color:var(--text-secondary);"></i>
                    </a>
                    ...
                    <a href="{{ route('admin.backup.download') }}"
                        ...
                        <div
                            style="width:30px;height:30px;border-radius:8px;
                                ...
                                display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                            <i class="bi bi-database" style="font-size:13px;color:white;"></i>
                        </div>
                        <div>
                            <div style="font-size:13px;font-weight:600;color:var(--text-primary);">Backup DB</div>
                            <div style="font-size:11px;color:var(--text-secondary);">Download SQL backup</div>
                        </div>
                        <i class="bi bi-chevron-right ms-auto" style="font-size:12px;color:var(--text-secondary);"></i>
                    </a>
                </div>
            ...
            <div class="stat-card">
                ...
                @empty
                    <div style="text-align:center;padding:1.5rem 0;color:var(--text-secondary);font-size:13px;">
                        No announcements yet.
                    </div>
                @endforelse
                <a href="{{ route('admin.board.index') }}"
                    style="display:block;margin-top:10px;font-size:12px;font-weight:600;
    ...
    {{-- ============================================================
     ANALYTICS SECTION  — paste this BELOW your existing content
     (after the Recent Activity row closes)
     ============================================================ --}}

    {{-- Section Header --}}
    <div class="d-flex align-items-center justify-content-between mt-4 mb-3 anim-fade-up delay-6">
        <div>
    ...
    {{-- ROW 1: Attendance Breakdown + Leave Types --}}
    <div class="row g-3 mb-3 anim-fade-up delay-6">

        {{-- Attendance This Month (visual bar breakdown) --}}
        <div class="col-lg-5">
            <div class="stat-card h-100">
                <div class="d-flex align-items-start justify-content-between mb-3">
                    ...
                    <div
                        style="width:36px;height:36px;border-radius:10px;background:rgba(74,144,226,0.12);
                    display:flex;align-items:center;justify-content:center;">
                        <i class="bi bi-bar-chart-line" style="color:#4A90E2;font-size:16px;"></i>
                    </div>
                </div>
                ...
                <div style="margin-bottom:14px;">
                    <div class="d-flex justify-content-between mb-1" style="font-size:12.5px;">
                        <span style="font-weight:600;color:var(--text-primary);">
                            ...
                            background:#22C55E;margin-right:6px;"></span>On-Time
                        </span>
                        <span style="color:var(--text-secondary);">
                            {{ $attendanceStats['on_time'] }} <span style="opacity:0.6;">({{ $onTimePct }}%)</span>
                        </span>
                    </div>
                    <div style="height:7px;border-radius:99px;background:var(--border);overflow:hidden;">
                        <div
                            style="height:100%;width:{{ $onTimePct }}%;background:linear-gradient(90deg,#4ADE80,#22C55E);
                ...
                <div style="margin-bottom:14px;">
                    <div class="d-flex justify-content-between mb-1" style="font-size:12.5px;">
                        <span style="font-weight:600;color:var(--text-primary);">
                            <span
                                style="display:inline-block;width:8px;height:8px;border-radius:50%;
                            background:#F59E0B;margin-right:6px;"></span>Late
                        </span>
                        <span style="color:var(--text-secondary);">
                            {{ $attendanceStats['late'] }} <span style="opacity:0.6;">({{ $latePct }}%)</span>
                        </span>
                    </div>
                    <div style="height:7px;border-radius:99px;background:var(--border);overflow:hidden;">
                        <div
                            style="height:100%;width:{{ $latePct }}%;background:linear-gradient(90deg,#FCD34D,#F59E0B);
                        border-radius:99px;">
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom:18px;">
                    <div class="d-flex justify-content-between mb-1" style="font-size:12.5px;">
                        <span style="font-weight:600;color:var(--text-primary);">
                            <span
                                style="display:inline-block;width:8px;height:8px;border-radius:50%;
                            background:#EF4444;margin-right:6px;"></span>Absent
                        </span>
                        <span style="color:var(--text-secondary);">
                            {{ $attendanceStats['absent'] }} <span style="opacity:0.6;">({{ $absentPct }}%)</span>
                        </span>
                    </div>
                    <div style="height:7px;border-radius:99px;background:var(--border);overflow:hidden;">
                        <div
                            style="height:100%;width:{{ $absentPct }}%;background:linear-gradient(90deg,#FCA5A5,#EF4444);
                        border-radius:99px;">
                        </div>
                    </div>
                </div>
                ...
                {{-- Avg Hours --}}
                <div
                    style="padding:10px 14px;border-radius:10px;background:rgba(74,144,226,0.07);
                border:1px solid rgba(74,144,226,0.14);display:flex;align-items:center;gap:10px;">
                    <i class="bi bi-clock" style="color:#4A90E2;font-size:15px;"></i>
        ...
        <div class="col-lg-4">
            <div class="stat-card h-100">
                ...
                @php
                    ...
                    $leaveColors = ['#4A90E2', '#F59E0B', '#22C55E', '#EF4444', '#8B5CF6', '#EC4899', '#14B8A6'];
                @endphp
                        ...
                        <div>
                            <div class="d-flex justify-content-between mb-1" style="font-size:12px;">
                                <span style="font-weight:600;color:var(--text-primary);">
                                    ...
                                    background:{{ $leaveColors[$i % count($leaveColors)] }};
                ...
                background:rgba(245,158,11,0.07);border:1px solid rgba(245,158,11,0.14);">
                        ...
                        <div style="font-size:13px;font-weight:700;color:var(--text-primary);">
                            {{ $topLeaveRequester->fullname }}
                        </div>
                        <div style="font-size:11px;color:var(--text-secondary);">
                            {{ $topLeaveRequester->total }} requests this year
                        </div>
                    </div>
                @endif
            </div>
                ...
                <div class="d-flex flex-column gap-2">
                    @php
                        $certStatuses = [
                            ...
                            ['label' => 'Rejected', 'key' => 'rejected', 'color' => '#EF4444', 'icon' => 'bi-x-circle'],
                        ];
                    @endphp
    ...
    {{-- ROW 2: Headcount Trend (sparkline) + Retirement Watch --}}
    <div class="row g-3 mb-3 anim-fade-up delay-6">
        ...
        <div class="col-lg-5">
            <div class="stat-card h-100">
                <div class="d-flex align-items-start justify-content-between mb-1">
                    ...
                    <div
                        style="width:36px;height:36px;border-radius:10px;background:rgba(139,92,246,0.12);
                    display:flex;align-items:center;justify-content:center;">
                        <i class="bi bi-graph-up" style="color:#8B5CF6;font-size:16px;"></i>
                    </div>
                </div>
                ...
                <div style="margin:10px -4px 8px;">
                    <svg viewBox="0 0 {{ $svgW }} {{ $svgH }}"
                        ...
                        <polyline points="{{ $polyline }}" fill="none" stroke="#8B5CF6" stroke-width="2"
                ...
                <div style="margin-top:12px;display:flex;gap:12px;">
                    <div
                        style="flex:1;padding:10px;border-radius:10px;background:rgba(139,92,246,0.07);
                    border:1px solid rgba(139,92,246,0.14);text-align:center;">
                            ...
                            font-size:12px;font-weight:700;color:{{ $uc['badge'] }};">
                                ...
                                white-space:nowrap;">
                                    ...
                                    <div style="font-size:10.5px;color:var(--text-secondary);margin-top:3px;">
                                        Born {{ \Carbon\Carbon::parse($emp->birthday)->format('M d, Y') }}
                                    </div>
                                </div>
                            </div>
                        @endforeach
