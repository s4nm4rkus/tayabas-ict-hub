...
@section('content')
    ...
    <div class="page-hero anim-fade-up mb-4">
        <div style="position:relative;z-index:1;">
            <div style="font-size:13px;opacity:0.85;font-weight:500;margin-bottom:4px;">Administrative Officer</div>
            <h4 style="font-size:20px;font-weight:700;margin-bottom:4px;">
                Welcome, {{ Auth::user()->username }} 👋
            </h4>
            <p style="font-size:13px;opacity:0.8;margin:0;">
                Here's an overview of leave requests pending your approval.
            </p>
        </div>
    </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="stat-card anim-fade-up delay-1" style="text-align:center;">
                <div style="font-size:32px;font-weight:800;color:#7C3AED;">{{ $pendingCount }}</div>
                <div style="font-size:13px;font-weight:600;color:var(--text-secondary);margin-top:4px;">
                    Pending Your Approval
                </div>
                <div style="margin-top:12px;">
                    <a href="{{ route('ao.leave.index') }}" class="btn btn-primary btn-sm">
                            ...
                            <td>
                                @php
                                    $cls = match (true) {
                                        ...
                                        $leave->leave_status === 'Pending AO' => 'badge-purple',
