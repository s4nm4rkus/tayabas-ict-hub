...
<head>
    ...
    <style>
        :root {
            ...
            --danger: #EF4444;
            --sidebar-width: 260px;
            --shadow-sm: 0 1px 3px rgba(99, 102, 241, 0.08), 0 1px 2px rgba(99, 102, 241, 0.06);
            --shadow-md: 0 4px 16px rgba(99, 102, 241, 0.12), 0 2px 6px rgba(99, 102, 241, 0.08);
            --radius: 14px;
            --radius-sm: 10px;
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <div class="brand-logo">
                <div class="brand-icon"><i class="bi bi-award-fill"></i></div>
        ...
        <div class="sidebar-nav">
            ...
            <a href="{{ route('asds.dashboard') }}"
                class="nav-link {{ request()->routeIs('asds.dashboard') ? 'active' : '' }}">
                <i class="bi bi-grid-1x2"></i> Dashboard
            </a>
            <div class="nav-section mt-2">Leave</div>
            <a href="{{ route('asds.leave.index') }}"
                class="nav-link {{ request()->routeIs('asds.leave.*') ? 'active' : '' }}">
                <i class="bi bi-calendar-check"></i> Leave Requests
            </a>
            <div class="nav-section mt-2">Account</div>
            <a href="{{ route('asds.profile.show') }}"
                class="nav-link {{ request()->routeIs('asds.profile.*') ? 'active' : '' }}">
