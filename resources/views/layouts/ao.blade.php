...
<head>
    ...
    <style>
        :root {
            ...
            --danger: #EF4444;
            --sidebar-width: 260px;
            --shadow-sm: 0 1px 3px rgba(139, 92, 246, 0.08), 0 1px 2px rgba(139, 92, 246, 0.06);
            --shadow-md: 0 4px 16px rgba(139, 92, 246, 0.12), 0 2px 6px rgba(139, 92, 246, 0.08);
            --radius: 14px;
            --radius-sm: 10px;
        ...
        * {
        ...
        .table tbody tr td {
            font-size: 13.5px;
            padding: 12px 14px;
            border-bottom: 1px solid rgba(245, 240, 255, 0.8);
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="{{ route('ao.dashboard') }}"
                class="nav-link {{ request()->routeIs('ao.dashboard') ? 'active' : '' }}">
                <i class="bi bi-grid-1x2"></i> Dashboard
            </a>
            <div class="nav-section mt-2">Leave</div>
            <a href="{{ route('ao.leave.index') }}"
                class="nav-link {{ request()->routeIs('ao.leave.*') ? 'active' : '' }}">
                <i class="bi bi-calendar-check"></i> Leave Requests
            </a>
            <div class="nav-section mt-2">Account</div>
            <a href="{{ route('ao.profile.show') }}"
                class="nav-link {{ request()->routeIs('ao.profile.*') ? 'active' : '' }}">
