...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            ...
            ['date_last_promotion', 'Optional', '06/01/2026 — triggers a real appointment/promotion event'],
            ...
            ['separation_date', 'Optional', '12/31/2024'],
                ...
                <a href="{{ route('hr.employees.bulk-update.template') }}" class="btn btn-outline-primary btn-sm">
            ...
            <div class="form-section anim-fade-up delay-2">
                ...
                <form method="POST" action="{{ route('hr.employees.bulk-update') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
