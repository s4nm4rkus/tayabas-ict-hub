        ...
        <div class="form-section anim-fade-up delay-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-text">Auto-generated and emailed to the employee.</div>
                </div>
            </div>
        </div>

        {{-- Note: HR cannot set account status --}}
        <div class="alert alert-info anim-fade-up delay-4 mb-4" style="font-size:13px;">
            <i class="bi bi-info-circle me-2"></i>
            <strong>Note:</strong> Account status is managed by the System Administrator only.
            New accounts are automatically set to <strong>Enabled</strong>.
        </div>
