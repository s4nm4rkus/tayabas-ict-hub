...
<head>
    <meta charset="UTF-8">
    <title>Certificate of No Accountability</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="cert-title">Certificate of No Accountability</div>
    ...
    <div class="body-text">
        ...
        of this office, has no pending financial, property, or administrative accountability
        with the Schools Division Office — Tayabas City as of this date.
    </div>

    <div class="body-text">
        All accountabilities, if any, have been duly settled and cleared by the
        concerned offices of this Division.
    </div>
