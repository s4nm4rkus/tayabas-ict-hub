...
// ── ICT Unit — public pages (no auth needed to browse) ───────────────────────
Route::get('/ict/forms', fn () => view('ict.request-forms'))->name('ict.forms');

// ══════════════════════════════════════════════════════════════════════════════
//  ICT — Employee-facing routes (submit forms, view own tickets)
// ══════════════════════════════════════════════════════════════════════════════
Route::middleware(['auth', 'role:Employee'])->group(function () {

    Route::get('/ict/ta-form', fn () => view('ict.forms.TA-form'))
        ->name('ict.ta-form');
    Route::post('/ict/ta-form', [IctTicketController::class, 'store'])
        ->name('ict.ta-form.store');

    Route::get('/ict/my-tickets', [IctTicketController::class, 'myTickets'])
        ->name('ict.my-tickets');

    Route::get('/ict/email-form', fn () => view('ict.forms.email-form'))
        ->name('ict.email-form');
    Route::post('/ict/email-form', [IctEmailRequestController::class, 'store'])
        ->name('ict.email-form.store');
    Route::get('/ict/dts-form', fn () => view('ict.forms.dts-request'))
        ->name('ict.dts-form');
    Route::post('/ict/dts-form', [IctDtsRequestController::class, 'store'])
        ->name('ict.dts-form.store');

    Route::get('/ict/helpdesk-form', fn () => view('ict.forms.helpdesk-form'))
        ->name('ict.helpdesk-form');
    Route::post('/ict/helpdesk-form', [IctHelpdeskRequestController::class, 'store'])
        ->name('ict.helpdesk-form.store');
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:Super Administrator')
        ...
        ->group(function () {
            ...
            // Dashboard
            Route::get('dashboard', [IctDashboardController::class, 'index'])
                ->name('dashboard');
            //  GET  /ict/admin/dashboard  →  ict.admin.dashboard
